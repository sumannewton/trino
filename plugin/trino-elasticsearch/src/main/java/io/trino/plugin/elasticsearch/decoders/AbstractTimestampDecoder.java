...
public class AbstractTimestampDecoder
        extends AbstractDecoder<Long>
{
    public AbstractTimestampDecoder()
    {
    ...
    public Long convert(String path, Object value)
    {
        ...
        if (value instanceof String) {
            ...
            if (epochMillis != null) {
                timestamp = LocalDateTime.ofInstant(convertToInstant(epochMillis), UTC);
            }
            else {
            ...
            timestamp = LocalDateTime.ofInstant(convertToInstant(((Number) value).longValue()), UTC);
        }
        else {
    ...
    private Instant convertToInstant(Long epochMillis)
    {
